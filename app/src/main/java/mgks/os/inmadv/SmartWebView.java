...
class SmartWebView {
	...
	// URL configs
	static String ASWV_URL            = "https://wind.penclub.club";  // complete URL of your website or offline webpage "file:///android_asset/offline.html";
	static String ASWV_SEARCH         = "https://www.baidu.com/s?wd=";         // search query will start by the end of the present string
